            ...
            <div class="content-left">
                ...
                <c:if test="${empty noContent}">
                    <c:forEach var="i" items="${content}">
                        <div class="border-post">
                            <span><a href="details-controller?id=${i.getId()}">${i.getTitle()}</a></span>
                            <div class="post">
                                <div class="left-post">
                                    <a href="details-controller?id=${i.getId()}"><img src="${i.getImgLink()}" alt=""></a>
                                </div>
                ...
                <div class="paging">
                    <c:forEach var="j" begin="1" step="1" end="${totalPage}">
                        <c:if test="${page != j}">
                            <a href="home-controller?page=${j}" >${j}</a> |
                        </c:if>
                        <c:if test="${page == j}">
                            ${j} |
                        </c:if>
