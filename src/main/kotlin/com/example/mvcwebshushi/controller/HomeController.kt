...
class HomeController : HttpServlet() {
    ...
    private fun processRequest(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        try {
            ...
            val info = infoModel.infoPage
            var totalPage = articleModel.totalRows
            ...
            if(page > totalPage){
                request.setAttribute("nonContent", "No article here!")
            }else{
                request.setAttribute("content", articleModel.getArticlesFromTo(page, pageSize))
            }
